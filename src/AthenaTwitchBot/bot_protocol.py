    ...
    def data_received(self, data: bytearray) -> None:
        ...
        for line in data.decode().split("\r\n"):
            ...
            if not line:
                ...
                self.handle_user_state(user_state, line=line)
