...
class BotLogic:
    def __new__(cls, *args, **kwargs) -> BotLogic:
        ...
        for item_name in obj.__dir__():
            ...
            if not callable(coroutine_callback := getattr(obj, item_name)) or not hasattr(coroutine_callback, "_command_logic_kwargs"):
                continue
